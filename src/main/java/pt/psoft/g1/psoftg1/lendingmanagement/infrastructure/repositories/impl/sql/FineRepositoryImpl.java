...
// import
// pt.psoft.g1.psoftg1.lendingmanagement.infrastructure.repositories.impl.sql.sqlmapper.FineEntityMapper;
...
// Optional<FineSqlEntity> entityOpt =
// fineRepo.findByLendingNumber(lendingNumber);
...
// return
// fineEntityMapper.toModel(fineRepo.save(fineEntityMapper.toEntity(fine)));
// }
