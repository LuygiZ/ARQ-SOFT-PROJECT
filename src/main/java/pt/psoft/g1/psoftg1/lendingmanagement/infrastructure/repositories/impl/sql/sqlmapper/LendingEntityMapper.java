...
// return number == null ? null : new
// LendingNumberSqlEntity(number.getLendingNumber());
// }
...
// : new Author(value.getName().toString(), value.getBio().toString(),
// value.getPhoto().toString());
// }
