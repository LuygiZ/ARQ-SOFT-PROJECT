    ...
    private void createLendings() {
        ...
        for (i = 0; i < 3; i++) {
            ...
            if (lendingRepository.findByLendingNumber("2025/" + seq).isEmpty()) {
                ...
                lending = Lending.newBootstrappingLending(books.get(i), readers.get(i * 2), 2025, seq, startDate,
        ...
        for (i = 0; i < 3; i++) {
            ...
            if (lendingRepository.findByLendingNumber("2025/" + seq).isEmpty()) {
                ...
                lending = Lending.newBootstrappingLending(books.get(1 + i), readers.get(1 + i * 2), 2025, seq,
        ...
        for (i = 0; i < 3; i++) {
            ...
            if (lendingRepository.findByLendingNumber("2025/" + seq).isEmpty()) {
                ...
                lending = Lending.newBootstrappingLending(books.get(3 / (i + 1)), readers.get(i * 2), 2025, seq,
                        startDate, null, lendingDurationInDays, fineValuePerDayInCents);
                lendingRepository.save(lending);
            }
        }
        ...
        for (i = 0; i < 3; i++) {
            ...
            if (lendingRepository.findByLendingNumber("2025/" + seq).isEmpty()) {
                ...
                lending = Lending.newBootstrappingLending(books.get(3 - i), readers.get(1 + i * 2), 2025, seq,
        ...
        for (i = 0; i < 6; i++) {
            ...
            if (lendingRepository.findByLendingNumber("2025/" + seq).isEmpty()) {
                ...
                lending = Lending.newBootstrappingLending(books.get(i), readers.get(i), 2025, seq, startDate,
                        returnedDate, lendingDurationInDays, fineValuePerDayInCents);
                lendingRepository.save(lending);
            }
        }
        ...
        for (i = 0; i < 6; i++) {
            ...
            if (lendingRepository.findByLendingNumber("2025/" + seq).isEmpty()) {
                ...
                lending = Lending.newBootstrappingLending(books.get(i), readers.get(1 + i % 4), 2025, seq, startDate,
                        returnedDate, lendingDurationInDays, fineValuePerDayInCents);
                lendingRepository.save(lending);
            }
        }
        ...
        for (i = 0; i < 6; i++) {
            ...
            if (lendingRepository.findByLendingNumber("2025/" + seq).isEmpty()) {
                ...
                lending = Lending.newBootstrappingLending(books.get(i), readers.get(i % 2 + 2), 2025, seq, startDate,
                        returnedDate, lendingDurationInDays, fineValuePerDayInCents);
                lendingRepository.save(lending);
            }
        }
        ...
        for (i = 0; i < 6; i++) {
            ...
            if (lendingRepository.findByLendingNumber("2025/" + seq).isEmpty()) {
                ...
                lending = Lending.newBootstrappingLending(books.get(i), readers.get(i % 2 + 3), 2025, seq, startDate,
        ...
        for (i = 0; i < 10; i++) {
            ...
            if (lendingRepository.findByLendingNumber("2025/" + seq).isEmpty()) {
                ...
                lending = Lending.newBootstrappingLending(books.get(i), readers.get(4 - i % 4), 2025, seq, startDate,
                        null, lendingDurationInDays, fineValuePerDayInCents);
                lendingRepository.save(lending);
            }
        }
