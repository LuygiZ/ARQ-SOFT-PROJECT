...
/**
 * ISBN lookup service using Open Library Search API
 * Searches in both 'isbn' field and 'ia' (Internet Archive) field
 */
@Component
public class OpenLibraryIsbnService implements IsbnService {
